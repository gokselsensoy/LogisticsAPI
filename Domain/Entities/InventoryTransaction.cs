...
namespace Domain.Entities
{
    public class InventoryTransaction : Entity
    {
        ...
        public InventoryTransaction(Guid inventoryId, Guid packageId, Guid ownerId, int quantityChange, int quantityAfter, TransactionType type, Guid userId, string? note)
        {
            Id = Guid.NewGuid();
